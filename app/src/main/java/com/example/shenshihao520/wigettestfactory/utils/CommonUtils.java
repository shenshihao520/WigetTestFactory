...
public class CommonUtils {
     ...
     * @param fileName ： property文件的名称（全称哦，包括后缀）
     * @return : 该节点对应的值
     */
    ...
    /**
     * @param log         : 打印的信息
     * @param txtFileName ：打印出来的txt文件的全名（包含后缀名哦）
     */
    ...
    /**
     * @param strContainPoint 带有小数点的数值型string
   ...
   */
    ...
    /**
     * 判断当前是否有网络 及网络类型  返回-1 认为无网络  1是wifi 2是4
     * @param c
     * @return
     */
    public static int isNetworkAvailable(Context c) {
    ...
    public static int getSDAvailableSize(Context context) {
        ...
        Log.i("asdasdasd",blockSize+"");
        Log.i("asdasdasd",availableBlocks+"");
        int size = (int)(blockSize * availableBlocks / 1024 /1024);
        return size;
    }
